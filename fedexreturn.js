...
if(create != null){
    ...
    console.log(values)
    setTimeout(fillFields(values), 1000);
function fillFields(arr){
    ...
    document.getElementById('fromData.companyName').value = ""
    document.getElementById('fromData.contactName').value = name
    document.getElementById('fromData.addressLine1').value = address1
    document.getElementById('fromData.addressLine2').value = address2
    document.getElementById('fromData.zipPostalCode').value = zip
    document.getElementById('fromData.city').value = city
    document.getElementById('fromData.stateProvinceCode').value = state
    document.getElementById('fromData.phoneNumber').value = phone
    document.getElementById('toData.contactName').value = "GOEDEKER, Inc."
    document.getElementById('toData.addressLine1').value = "3817 Millstone Parkway"
    document.getElementById('toData.addressLine2').value = address2
    document.getElementById('toData.zipPostalCode').value = 63301
    document.getElementById('toData.city').value = "SAINT CHARLES"
    document.getElementById('toData.stateProvinceCode').value = "MO"
    document.getElementById('toData.phoneNumber').value = 6362077277
